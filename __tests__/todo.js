...
describe("To do list test suits", () => {
  beforeAll(() => {
    ...
    add({ title: "car service", dueDate: today, completed: false });
    add({ title: "project", dueDate: tomorrow, completed: false });
    add({ title: "purchasing", dueDate: tomorrow, completed: false });
  });
